...
VALUES (nextval('inclusao_pedido'), 'Concluido', '2023-11-20', '2023-11-25', 250.00, 3, 1),
       ...
       (nextval('inclusao_pedido'), 'Concluido', '2023-11-20', '2023-11-25', 250.00, 6, 1),
       ...
       (nextval('inclusao_pedido'), 'Em Separação', '2023-10-28', '2023-11-05', 350.00, 1, 4),
       (nextval('inclusao_pedido'), 'Em rota de entrega', '2023-11-20', '2023-11-25', 250.00, 3, 1),
       (nextval('inclusao_pedido'), 'Concluido', '2023-11-02', '2023-11-05', 150.00, 3, 1),
       ...
       (nextval('inclusao_pedido'), 'Em rota de entrega', '2023-11-22', '2023-11-25', 350.00, 3, 3),
       (nextval('inclusao_pedido'), 'Concluido', '2023-11-08', '2023-11-15', 580.00, 2, 2),
...
values (nextval('inclusao_pedidos_produtos'), 1, 1, 10),
       ...
       (nextval('inclusao_pedidos_produtos'), 2, 10, 100),
       (nextval('inclusao_pedidos_produtos'), 2, 4, 211),
       (nextval('inclusao_pedidos_produtos'), 2, 6, 30),
       (nextval('inclusao_pedidos_produtos'), 3, 11, 10),
       (nextval('inclusao_pedidos_produtos'), 4, 21, 11),
       (nextval('inclusao_pedidos_produtos'), 5, 13, 3),
       (nextval('inclusao_pedidos_produtos'), 6, 10, 100),
       (nextval('inclusao_pedidos_produtos'), 7, 5, 211),
       (nextval('inclusao_pedidos_produtos'), 7, 9, 30)
